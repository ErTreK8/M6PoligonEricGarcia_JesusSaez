...
namespace M6Poligon.CLASSES
{
    public class ClTriangleRectangle : ClPoligon                 // ClPoligons és la superclasse de la que es deriva ClQuadrat
    {
        ...
        public ClTriangleRectangle(Form xfrmMain, Point xcentre, String xtipus, int xwidth, int xheight) : base(xfrmMain, xcentre)
        {
            Width = xwidth;
            Height = xheight;
            Tipus = xtipus;
        ...
        public ClTriangleRectangle(Form xfrmMain, Point xcentre, Color xcolor, String xtipus, int xwidth, int xheight) : base(xfrmMain, xcentre, xcolor)
        {
            Width = xwidth;
            Height = xheight;
            Tipus = xtipus;
